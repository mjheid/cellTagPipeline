...
bam.test.obj <- CellTagDataPostCollapsing(celltag.obj = bam.test.obj, collapsed.rslt.file = paste0(DIR, opt$collapsing_name))

bam.test.obj <- SingleCellDataBinarization(bam.test.obj, opt$tagged) #2)
