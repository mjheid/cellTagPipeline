...
./control.sh cellTag --visualize --save_progress_name "original" --tagged 1 --low_filter 1 --bam_data "data/test_data/hf1.d15.possorted_genome_bam.bam"  --whitelist_version "v1" --sample_name "og"
./control.sh cellTag --visualize --save_progress_name "original" --tagged 1 --low_filter 1 --bam_data "data/test_data/hf1.d15.possorted_genome_bam.bam"  --whitelist_version "v2"
./control.sh cellTag --visualize --save_progress_name "original" --tagged 1 --low_filter 1 --bam_data "data/test_data/hf1.d15.possorted_genome_bam.bam"  --whitelist_version "v3"