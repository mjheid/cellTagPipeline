...
./control.sh cellTag --visualize --save_progress_name "insert" --tagged 1 --low_filter 1 --bam_data "data/bam/data.bam"  --whitelist_version "v1" --sample_name "SI-TT-H4"
./control.sh cellTag --visualize --save_progress_name "insert" --tagged 1 --low_filter 1 --bam_data "data/bam/data.bam"  --whitelist_version "v2" --sample_name "SI-TT-H4"
./control.sh cellTag --visualize --save_progress_name "insert" --tagged 1 --low_filter 1 --bam_data "data/bam/data.bam"  --whitelist_version "v3" --sample_name "SI-TT-H4"